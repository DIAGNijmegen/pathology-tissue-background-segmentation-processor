...
class NatureNet256v1(dmsmodelbase.LasagneModelBase):
    """Nature-net 256 v1 network model."""
    ...
    def _buildnetworkfromdefinition(self):
        ...
        convolution_layer_3_filter_count = convolution_layer_2_filter_count * 2
        ...
        # Max pooling layer 3.
        #
        pooling_layer_3_name = 'pool_3'
        network[pooling_layer_3_name] = L.MaxPool2DLayer(incoming=network[convolution_layer_3_name],
                                                         name=pooling_layer_3_name, pool_size=2, stride=2)
        # Convolutional layer 4.
        #
        convolution_layer_4_name = 'convolution_4'
        convolution_layer_4_filter_count = convolution_layer_3_filter_count * 2
        network[convolution_layer_4_name] = L.Conv2DLayer(incoming=network[pooling_layer_3_name],
                                                          name=convolution_layer_4_name,
                                                          num_filters=convolution_layer_4_filter_count,
                                                          filter_size=3,
                                                          pad='valid',
                                                          W=lasagne.init.HeNormal(gain='relu'),
                                                          nonlinearity=lasagne.nonlinearities.rectify)
        ...
        # Max pooling layer 4.
        #
        pooling_layer_4_name = 'pool_4'
        network[pooling_layer_4_name] = L.MaxPool2DLayer(incoming=network[convolution_layer_4_name],
                                                         name=pooling_layer_4_name, pool_size=2, stride=2)

        # Convolutional layer 5.
        #
        convolution_layer_5_name = 'convolution_5'
        convolution_layer_5_filter_count = convolution_layer_4_filter_count
        network[convolution_layer_5_name] = L.Conv2DLayer(incoming=network[pooling_layer_4_name],
        ...
        #
        convolution_layer_6_name = 'convolution_6'
        convolution_layer_6_filter_count = convolution_layer_5_filter_count
        network[convolution_layer_6_name] = L.Conv2DLayer(incoming=network[convolution_layer_5_name],
                                                          name=convolution_layer_6_name,
                                                          num_filters=convolution_layer_6_filter_count,
                                                          filter_size=1,
                                                          pad='valid',
                                                          W=lasagne.init.HeNormal(gain='relu'),
                                                          nonlinearity=lasagne.nonlinearities.rectify)
        ...
        #
        if self.__batch_norm:
            network[convolution_layer_6_name] = L.batch_norm(network[convolution_layer_6_name])

        # Add dropout layer.
        #
        if 0 < self.__dropout_count:
            dropout_layer_6_name = 'dropout_6'
            dropout_layer_6_params = {'name': dropout_layer_6_name, 'p': self.__dropout_prob, 'rescale': True}
            output_incoming = dropout_layer_6_name
            network[dropout_layer_6_name] = L.dropout_channels(incoming=network[convolution_layer_6_name], **dropout_layer_6_params)
        else:
            output_incoming = convolution_layer_6_name
